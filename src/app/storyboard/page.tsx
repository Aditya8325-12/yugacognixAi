  ...
  return (
    <div className="w-full p-4 ">
      <div className="w-full flex justify-between h-[86vh]     gap-4">
        ...
        <div className="w-4/12 bg-white  overflow-y-auto p-4 border border-slate-200 rounded-md shadow-xl ">
          <h1 className="font-bold text-gray-600 my-4">
            1.Lorem ipsum dolor sit.
          </h1>
          <p className="text-gray-600">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, iure
            alias, similique nesciunt necessitatibus eius provident vitae
            ...
            harum architecto blanditiis dolorum! Expedita placeat atque tenetur?
            Nisi ipsa quidem voluptatem unde obcaecati voluptatum qui culpa,
            nulla reiciendis at nam soluta, incidunt quaerat ab ullam vel! Magni
            nam deserunt nesciunt, repellendus enim quibusdam molestias
            molestiae et autem perspiciatis nisi ad ex optio quia sit dolorem
            illo? Harum sed accusamus, consectetur asperiores voluptates
            eligendi natus explicabo, corrupti, doloribus cumque doloremque
            incidunt aliquid libero qui labore nostrum?
          </p>
          <h1 className="font-bold text-gray-600 my-4">
